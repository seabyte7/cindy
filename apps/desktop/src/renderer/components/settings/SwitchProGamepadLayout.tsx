...
import * as Art from './switchProSilhouette';
 ...
 * Switch Pro prints Nintendo letters, so physical B/A/Y/X map onto a/b/x/y.
 */
export function SwitchProGamepadLayout({
  disabled = false,
  hintFor,
  onEdit,
  preview,
  ...
  return (
    <GamepadArtBoard
      testId="switch-pro-gamepad-layout"
      hits={
        <>
          <GeomHit
            part="lt"
          ...
          <GeomHit
            ...
            onEdit={onEdit}
          />
          <g data-testid="switch-pro-gamepad-dpad">
            <GeomHit
              part="dpadUp"
          ...
          <g data-testid="switch-pro-gamepad-face">
            <GeomHit
              part="a"
              geom={Art.PRESS_B}
              hint={hintFor('a')}
    ...
    >
      ...
      <GeomShapes geoms={Art.SHOULDER} />
      <GeomShapes geoms={Art.TOP_PANEL} />
      <GeomShapes geoms={Art.USB} />
      <GeomShape geom={Art.SYNC} />
      <GeomShape geom={Art.RECHARGE_LED} />
      <GeomShapes geoms={Art.NFC_TOUCHPOINT} />
